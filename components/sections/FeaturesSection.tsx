...
const featureIcons = [
  (
    <svg key={0} viewBox="0 0 44 44" fill="none" className="w-8 h-8">
  ...
  (
    <svg key={1} viewBox="0 0 44 44" fill="none" className="w-8 h-8">
  ...
  (
    <svg key={2} viewBox="0 0 44 44" fill="none" className="w-8 h-8">
        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-start">
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="font-body text-xs tracking-widest uppercase text-copper" style={{letterSpacing:"0.22em"}}>{t("features.eyebrow")}</span>
            </div>
            ...
            <h2 className="font-display font-light leading-none text-offwhite mb-6" style={{ fontSize:"clamp(2.5rem,4.5vw,4rem)" }}>
              ...
              {t("features.titleB")}<br/>
              <em className="italic text-copper not-italic">{t("features.titleC")}</em>
            </h2>
