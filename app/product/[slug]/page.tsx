...
export default function ProductPage() {
  ...
  const formattedInstallments = (product.priceVal / 4).toFixed(2);
  const monthlyPlan = (product.priceVal / 12).toFixed(2);
            ...
            <div className="lg:col-span-6 space-y-6 lg:pl-4">
              ...
              <div className="space-y-2">
                <div className="flex items-baseline gap-3">
                  ...
                  <span className="font-body text-xs text-stone-light">USD</span>
                </div>
